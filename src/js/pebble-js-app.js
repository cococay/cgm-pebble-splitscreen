...
function fetchCgmData(lastReadTime, lastBG) {
    ...
    req.open('GET', "nightscoutnrh2.azurewebsites.net/pebble", true); //edit name below in message
    var req2 = new XMLHttpRequest();
    req2.open('GET', "nightscoutnrh3.azurewebsites.net/pebble", true); // edit name below in message 
